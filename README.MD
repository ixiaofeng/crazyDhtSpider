...
3.Please download the corresponding swoole executable file from the swoole official website and place it in the same directory as dht_client and dht_server

4.run ./swoole-cli dht_client/client.php
