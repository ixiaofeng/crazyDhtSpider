...
> ⚠️ **Important**: Many users fail to collect data because they forget to open port 6882!
...
Import the `dht.sql` file into your database. The bt table has 31 partitions by default.
